    ...
    def post(self):
        ...
        if SuperUserPermission().can():
            ...
            return {
                ...
                "email": email,
                "password": password,
                "encrypted_password": authentication.encrypt_user_password(password).decode("ascii"),
            }
    ...
    def put(self, username):
        ...
        if SuperUserPermission().can():
            ...
            if user_data.get("password") is not None:
                ...
                return_value["encrypted_password"] = authentication.encrypt_user_password(password).decode("ascii")
